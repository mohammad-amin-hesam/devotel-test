...
function Calendar({
  ...
  const [navView, setNavView] = React.useState<"days" | "years">(
    "days"
  );
        ...
        Nav: ({ className }) => {
          ...
          return (
            <nav className={cn("flex items-center", className)}>
              <Button
                variant="outline"
                className="absolute left-0 h-7 w-7 bg-transparent p-0 opacity-80
                  hover:opacity-100"
                type="button"
              ...
              <Button
                variant="outline"
                className="absolute right-0 h-7 w-7 bg-transparent p-0 opacity-80
                  hover:opacity-100"
                type="button"
          ...
          return (
            ...
            >
              {navView === "days"
                ? children
                : toPersian(
                    moment(displayYears.from, "YYYY").format("jYYYY")
                  ) +
                  " - " +
                  toPersian(
                    moment(displayYears.to, "YYYY").format("jYYYY")
                  )}
            </Button>
          );
        },
