...
>(
  (
    {
      defaultOpen = typeof localStorage !== "undefined" &&
      localStorage.getItem("desktop-siderbar")
        ? JSON.parse(
            localStorage.getItem("desktop-siderbar") as string
          )
        : true,
      open: openProp,
    ...
    const toggleSidebar = React.useCallback(() => {
      localStorage.setItem("desktop-siderbar", JSON.stringify(!open));
